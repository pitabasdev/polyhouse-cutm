...
app.get("/addsensordata/:id/val1/:v1/val2/:v2/val3/:v3/", async (req, res) => {
  //for nodemcu to add data to db.
  console.log(req.params);
  try {
    const response = await sensorinfoModel.create({
      polyhsid: req.params.id,
...
app.get("/download/:id", (req, res) => {
  fields = ["polyhsid", "temp", "humidity", "moisture", "date"];
